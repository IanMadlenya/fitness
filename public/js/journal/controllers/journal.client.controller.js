    ...
    function($scope, $routeParams, $location, Authentication, Journals) {
        ...
        $scope.create = function() {
            ...
            journal.$save(function(response) {
            	// If an journal was created successfully, redirect the user to the journal's page 
        ...
        $scope.update = function() {
            ...
            $scope.journal.$update(function() {
            	// If an journal was updated successfully, redirect the user to the journal's page 
